...
from media_gathering.link_search.pixiv_novel.pixiv_novel_downloader import DownloadResult, PixivNovelDownloader
from media_gathering.link_search.pixiv_novel.pixiv_novel_save_directory_path import PixivNovelSaveDirectoryPath
...
logger = getLogger("media_gathering.link_search.pixiv_novel.pixiv_novel_downloader")
