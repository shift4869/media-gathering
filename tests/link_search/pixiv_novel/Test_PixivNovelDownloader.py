...
from media_gathering.link_search.pixiv_novel.PixivNovelDownloader import DownloadResult, PixivNovelDownloader
...
logger = getLogger("media_gathering.link_search.pixiv_novel.PixivNovelDownloader")
