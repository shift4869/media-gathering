...
class TestNijieFetcher(unittest.TestCase):
    ...
    def _get_instance(self):
        with ExitStack() as stack:
            self.mock_login = stack.enter_context(patch("media_gathering.link_search.nijie.NijieFetcher.NijieFetcher.login"))
    ...
    def test_login(self):
        ...
        with ExitStack() as stack:
            mock_path_open = stack.enter_context(patch("media_gathering.link_search.nijie.NijieFetcher.Path.open", mock_open()))
            mock_get = stack.enter_context(patch("media_gathering.link_search.nijie.NijieFetcher.httpx.get"))
            mock_post = stack.enter_context(patch("media_gathering.link_search.nijie.NijieFetcher.httpx.post"))
            mock_nijie_cookie = stack.enter_context(patch("media_gathering.link_search.nijie.NijieFetcher.NijieCookie"))
        ...
        with ExitStack() as stack:
            mock_read_bytes = stack.enter_context(patch("media_gathering.link_search.nijie.NijieFetcher.Path.read_bytes"))
            mock_nijie_cookie = stack.enter_context(patch("media_gathering.link_search.nijie.NijieFetcher.NijieCookie"))
    ...
    def test_fetch(self):
        with ExitStack() as stack:
            mock_nijie_downloader = stack.enter_context(patch("media_gathering.link_search.nijie.NijieFetcher.NijieDownloader"))
