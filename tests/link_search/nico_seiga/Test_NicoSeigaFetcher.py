...
from media_gathering.link_search.nico_seiga.NicoSeigaDownloader import NicoSeigaDownloader
...
class TestNicoSeigaFetcher(unittest.TestCase):
    ...
    def test_NicoSeigaFetcher(self):
        with ExitStack() as stack:
            m_session = stack.enter_context(patch("media_gathering.link_search.nico_seiga.NicoSeigaFetcher.NicoSeigaSession"))
    ...
    def test_fetch(self):
        with ExitStack() as stack:
            m_session = stack.enter_context(patch("media_gathering.link_search.nico_seiga.NicoSeigaFetcher.NicoSeigaSession"))
            m_downloader = stack.enter_context(patch("media_gathering.link_search.nico_seiga.NicoSeigaFetcher.NicoSeigaDownloader"))
