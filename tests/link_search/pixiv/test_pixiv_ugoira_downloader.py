...
from media_gathering.link_search.pixiv.pixiv_ugoira_downloader import DownloadResult, PixivUgoiraDownloader
...
logger = getLogger("media_gathering.link_search.pixiv.pixiv_ugoira_downloader")
...
class TestPixivUgoiraDownloader(unittest.TestCase):
    ...
    def test_download(self):
        with ExitStack() as stack:
            mock_sleep = stack.enter_context(patch("media_gathering.link_search.pixiv.pixiv_ugoira_downloader.sleep"))
            mock_image = stack.enter_context(patch("media_gathering.link_search.pixiv.pixiv_ugoira_downloader.Image"))
