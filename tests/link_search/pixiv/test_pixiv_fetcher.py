...
logger = getLogger("media_gathering.link_search.pixiv.pixiv_fetcher")
...
class TestPixivFetcher(unittest.TestCase):
    ...
    def get_instance(self):
        with ExitStack() as stack:
            m_login = stack.enter_context(patch("media_gathering.link_search.pixiv.pixiv_fetcher.PixivFetcher.login"))
    ...
    def test_login(self):
        with ExitStack() as stack:
            mock_aapi = stack.enter_context(patch("media_gathering.link_search.pixiv.pixiv_fetcher.AppPixivAPI"))
