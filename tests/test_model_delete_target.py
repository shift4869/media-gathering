...
class TestModelDeleteTarget(unittest.TestCase):
    def make_instance(self, index: int) -> DeleteTarget:
        ...
        return DeleteTarget(tweet_id, delete_done, created_at, deleted_at, tweet_text, add_num, del_num)
    ...
    def test_init(self):
        ...
        add_num = 0
        del_num = 0
        actual = DeleteTarget(tweet_id, delete_done, created_at, deleted_at, tweet_text, add_num, del_num)
