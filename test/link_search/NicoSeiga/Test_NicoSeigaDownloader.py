...
from media_gathering.link_search.NicoSeiga.NicoSeigaDownloader import DownloadResult, NicoSeigaDownloader
from media_gathering.link_search.NicoSeiga.NicoSeigaInfo import NicoSeigaInfo
from media_gathering.link_search.NicoSeiga.NicoSeigaSaveDirectoryPath import NicoSeigaSaveDirectoryPath
...
class TestNicoSeigaDownloader(unittest.TestCase):
    ...
    def test_NicoSeigaDownloader(self):
        ...
        with ExitStack() as stack:
            m_sessionlogin = stack.enter_context(patch("media_gathering.link_search.NicoSeiga.NicoSeigaSession.NicoSeigaSession.login"))
            m_is_valid = stack.enter_context(patch("media_gathering.link_search.NicoSeiga.NicoSeigaSession.NicoSeigaSession._is_valid"))
    ...
    def test_download(self):
        ...
        with ExitStack() as stack:
            m_is_valid = stack.enter_context(patch("media_gathering.link_search.NicoSeiga.NicoSeigaDownloader.NicoSeigaDownloader._is_valid"))
            # m_mkdir = stack.enter_context(patch("media_gathering.link_search.NicoSeiga.NicoSeigaDownloader.Path.mkdir"))
            # m_open = stack.enter_context(patch("media_gathering.link_search.NicoSeiga.NicoSeigaDownloader.Path.open", mock_open()))
            m_logger_info = stack.enter_context(patch("media_gathering.link_search.NicoSeiga.NicoSeigaDownloader.logger.info"))
