...
class TestNicoSeigaSession(unittest.TestCase):
    def _get_session(self):
        with ExitStack() as stack:
            mock_session = stack.enter_context(patch("media_gathering.link_search.NicoSeiga.NicoSeigaSession.httpx.Client"))
            mock_is_valid = stack.enter_context(patch("media_gathering.link_search.NicoSeiga.NicoSeigaSession.NicoSeigaSession._is_valid"))
