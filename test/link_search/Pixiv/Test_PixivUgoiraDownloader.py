...
from media_gathering.link_search.Pixiv.PixivUgoiraDownloader import DownloadResult, PixivUgoiraDownloader
...
logger = getLogger("media_gathering.link_search.Pixiv.PixivUgoiraDownloader")
...
class TestPixivUgoiraDownloader(unittest.TestCase):
    ...
    def test_download(self):
        with ExitStack() as stack:
            mock_sleep = stack.enter_context(patch("media_gathering.link_search.Pixiv.PixivUgoiraDownloader.sleep"))
            mock_image = stack.enter_context(patch("media_gathering.link_search.Pixiv.PixivUgoiraDownloader.Image"))
