...
from media_gathering.link_search.Pixiv.PixivWorkDownloader import DownloadResult, PixivWorkDownloader
from media_gathering.link_search.Pixiv.Workid import Workid
from media_gathering.link_search.URL import URL

logger = getLogger("media_gathering.link_search.Pixiv.PixivWorkDownloader")
...
class TestPixivWorkDownloader(unittest.TestCase):
    ...
    def test_download(self):
        with ExitStack() as stack:
            mock_sleep = stack.enter_context(patch("media_gathering.link_search.Pixiv.PixivWorkDownloader.sleep"))
            mock_ugoira = stack.enter_context(patch("media_gathering.link_search.Pixiv.PixivWorkDownloader.PixivUgoiraDownloader"))
            ...
            base_path = Path("./test/link_search/Pixiv")
